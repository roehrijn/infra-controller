...
const GENERATED_HEADER_PREFIX: &str = "// This file is @generated by ";
...
pub fn check(fix: bool) -> eyre::Result<CheckOutcome> {
    ...
    for entry in walk.filter_map(Result::ok) {
        ...
        // Generated sources are owned by their generator and may contain
        // messages whose spelling we cannot change. Trust the generator's
        // canonical file banner rather than maintaining a path allowlist.
        if is_generated_source(&src) {
            generated += 1;
            continue;
        }
...
/// Whether the source declares itself generated in its leading file banner.
fn is_generated_source(src: &str) -> bool {
    src.lines()
        .next()
        .is_some_and(|line| line.starts_with(GENERATED_HEADER_PREFIX))
}
...
impl CheckOutcome {
    pub fn report_and_exit(self) -> ! {
        if self.fixing {
            ...
            println!(
                "\nScanned {} files ({} generated and {} unparseable, skipped).",
                self.scanned, self.generated, self.unparseable
            );
            println!(
...
mod tests {
    ...
    #[test]
    fn recognizes_only_leading_generated_file_banners() {
        let cases = [
            (
                "prost-generated source",
                "// This file is @generated by prost-build.\nfn generated() {}\n",
                true,
            ),
            ("handwritten source", "fn handwritten() {}\n", false),
            (
                "later generated mention",
                "fn handwritten() {}\n// This file is @generated by a test.\n",
                false,
            ),
        ];

        for (name, src, expected) in cases {
            assert_eq!(is_generated_source(src), expected, "{name}");
        }
    }
